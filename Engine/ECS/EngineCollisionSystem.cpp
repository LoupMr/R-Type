#include "EngineCollisionSystem.hpp"

namespace Engine {

    void EngineCollisionSystem::update(float dt, EntityManager& em, ComponentManager& cm) {
        (void)dt;
    ...
    bool EngineCollisionSystem::checkOverlap(const Collider& a, const Collider& b) {
